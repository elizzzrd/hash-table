#!/bin/bash
g++ -g -DDEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ \
...
-Wlarger-than=8192 -Wstack-usage=8192 -pie -fPIE -Werror=vla -mavx2 -mfma -I headers main.cpp hash_table.cpp \
 hash_functions.cpp text.cpp load_ht.cpp analyse.cpp benchmark.cpp errors_ht.cpp